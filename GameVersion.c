...
static const struct GameVersion version_cpe  = { 
	"0.30", VERSION_0020, 
	PROTOCOL_0030, BLOCK_MAX_CPE, 
	 10, sizeof(v7_inventory), v7_inventory, v5_hotbar
};
...
static const struct GameVersion version_0020 = {
	"0.0.19", VERSION_0020,
	PROTOCOL_0030, BLOCK_OBSIDIAN,
...
void GameVersion_Load(void) {
	int version = Options_GetInt(OPT_GAME_VERSION, VERSION_0017, VERSION_0019, VERSION_0030);
